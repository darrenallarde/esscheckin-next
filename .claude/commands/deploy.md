...
4. **Switch and merge:** After approval:
   - `git checkout main`
   - `git pull origin main`
   - `git merge <feature-branch> --no-ff`
5. **Push:** Push main to origin (triggers Vercel deploy). Confirm before pushing.
6. **Cleanup:** Ask if the feature branch should be deleted.
