...
import {
  useOrgContacts,
  type OrgContact,
} from "@/hooks/queries/use-org-contacts";
  ...
  const handleSend = async () => {
    ...
    for (let i = 0; i < selected.length; i++) {
      ...
      if (result.success) {
        ...
        toast.error(
          `Failed to send to ${recipient.firstName} ${recipient.lastName}`,
        );
      }
    }
        ...
        <div className="space-y-3 mt-auto">
          ...
          <div className="flex items-center justify-between">
            ...
            <Button
              onClick={handleSend}
              disabled={
                !message.trim() || sending || message.length > SMS_MAX_LENGTH
              }
