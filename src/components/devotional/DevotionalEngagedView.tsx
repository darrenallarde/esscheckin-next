...
export function DevotionalEngagedView({ devotionalId, firstName, onSignOut }: DevotionalEngagedViewProps) {
  const { engagement, isLoading, isSaving, saveJournal, savePrayerRequest } = useDevotionalEngagement(devotionalId, true);
    ...
    <section className="bg-white rounded-xl border border-stone-200 shadow-sm overflow-hidden">
      ...
      <div className="px-6 pb-5">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-xs font-semibold uppercase tracking-wider text-stone-500">Journal</span>
        </div>
        ...
        {journalSubmitted ? (
          <div className="rounded-lg border border-amber-200 bg-amber-50 p-4 animate-pop-in">
            ...
            <div className="flex items-center gap-1.5 mt-3">
              ...
              <span className="text-xs text-amber-600 font-medium">Submitted</span>
            </div>
            <button
          ...
          <div className="space-y-2">
            <textarea
              ...
              rows={3}
              className="w-full resize-none rounded-lg border border-stone-200 bg-stone-50 px-3 py-2.5 text-sm text-stone-800 placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-amber-300 focus:border-transparent"
            />
            <Button
      ...
      <div className="px-6 py-5">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-xs font-semibold uppercase tracking-wider text-stone-500">Prayer Request</span>
        </div>
        ...
        {prayerSubmitted ? (
          <div className="rounded-lg border border-rose-200 bg-rose-50 p-4 animate-pop-in">
            ...
            <div className="flex items-center gap-1.5 mt-3">
              ...
              <span className="text-xs text-rose-600 font-medium">Submitted</span>
            </div>
            <button
          ...
          <div className="space-y-2">
            <textarea
              ...
              rows={3}
              className="w-full resize-none rounded-lg border border-stone-200 bg-stone-50 px-3 py-2.5 text-sm text-stone-800 placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-rose-300 focus:border-transparent"
            />
            <Button
