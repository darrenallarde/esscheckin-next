...
-- This version properly drops ALL existing function signatures first

-- Drop ALL versions of the function (regardless of parameters)
DROP FUNCTION IF EXISTS public.register_student_and_checkin CASCADE;
...
-- Add comment
COMMENT ON FUNCTION public.register_student_and_checkin IS 'Register new student with address fields and create initial check-in';
