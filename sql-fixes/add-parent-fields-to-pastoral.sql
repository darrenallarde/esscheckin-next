-- Add mother/father specific fields to pastoral analytics function
-- This allows the Quick Actions UI to show proper parent names and relationships
...
'Returns pastoral analytics with full parent contact info (mother/father specific fields). Priority 1=most urgent (Missing), 6=least urgent (Ultra-Core).';
