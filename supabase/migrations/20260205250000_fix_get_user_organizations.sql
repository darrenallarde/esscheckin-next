-- =============================================================================
-- FIX get_user_organizations TO USE NEW PROFILES SYSTEM
-- =============================================================================
-- The function was querying organization_members (legacy table) but
-- super_admin_join_organization writes to organization_memberships.
-- This migration updates the function to query profiles + organization_memberships.
-- =============================================================================
